...
public enum CameraMode {
    AUTO(true, R.string.mode_auto, R.string.mode_auto, false, false, true) { // from class: openlight.co.camera.CameraMode.1
        @Override // openlight.co.camera.CameraMode
        public boolean isAuto() {
            return true;
        }
    },
    ISO(true, R.string.mode_iso, R.string.mode_short_iso, true, false, true) { // from class: openlight.co.camera.CameraMode.2
        @Override // openlight.co.camera.CameraMode
        public boolean isIso() {
            return true;
        }
    },
    SHUTTER(true, R.string.mode_shutter, R.string.mode_short_shutter, false, true, true) { // from class: openlight.co.camera.CameraMode.3
        @Override // openlight.co.camera.CameraMode
        public boolean isShutter() {
            return true;
        }
    },
    MANUAL(true, R.string.mode_manual, R.string.mode_manual, true, true, false) { // from class: openlight.co.camera.CameraMode.4
        @Override // openlight.co.camera.CameraMode
        public boolean isManual() {
            return true;
        }
    },
    VIDEO(FeatureManager.get().getBoolean("video.feature", true), R.string.mode_video_beta, R.string.mode_video, false, false, false) { // from class: openlight.co.camera.CameraMode.5
        @Override // openlight.co.camera.CameraMode
